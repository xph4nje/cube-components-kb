<?php
    ...
    $positionLogo = $this->getProp("Posizione Logo", "logo-title");
            ...
            <div class="base-block-list__element__inner <?php if ($hr) { echo "hr"; } ?>">
                ...
                <div class="base-block-list__element__text">
                    <div class="base-block-list__element__text__inner">
                        <?php if ($positionLogo == "logo-title" && isset($block['Logo']) && is_array($block['Logo']) && count($block['Logo']) > 0) { ?>
                        <div class="base-block-list__element__logo">
                        <?php
                            $title = $this->cleanTitle($block['Titolo'] . ( $block['Sottotitolo'] != "" ? " - " . $block['Sottotitolo'] : "" ));
                            $pictureParams = [
                                'image' => $block['Logo'][0]['files'],
                                'title' => $title,
                                'priority' => false,
                                'desktop' => 'medium'
                            ];
                        ...
                        <div class="base-block-list__element__text__ctas">
                            ...
                            ?>
                            <a class="cta" href="<?php echo $cta['link']; ?>" aria-label="<?php echo $ariaLabel; ?>"><?php echo $cta['label']; ?></a>
                            <?php
                                    }
                                }
                            ?>
